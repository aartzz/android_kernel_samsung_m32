...
/* ===== Multi-Generational LRU (MGLRU) support ===== */

/* Forward declarations from vmscan.c */

static inline void lru_gen_init_list(struct list_head *list)
{
        INIT_LIST_HEAD(list);
}
...
static inline int page_lru_gen_type(struct page *page)
{
        return page_is_file_lru(page) ? LRU_GEN_FILE : LRU_GEN_ANON;
}
