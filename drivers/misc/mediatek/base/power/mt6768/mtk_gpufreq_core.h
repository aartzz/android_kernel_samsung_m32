 ...
 **************************************************/
#define SEG_GPU_DVFS_FREQ0          1100000
...
/* Rampa de VGPU Suavizada e com Undervolt */
#define SEG_GPU_DVFS_VOLT0        87500   /* 10uV (Antigo VOLT3) */
#define SEG_GPU_DVFS_VOLT1        85000   /* 10uV (Antigo VOLT4) */
#define SEG_GPU_DVFS_VOLT2        82500   /* 10uV (Antigo VOLT5) */
#define SEG_GPU_DVFS_VOLT3        80000   /* 10uV (Antigo VOLT6) */
#define SEG_GPU_DVFS_VOLT4        79375   /* 10uV (Antigo VOLT7) */
#define SEG_GPU_DVFS_VOLT5        78125   /* 10uV (Antigo VOLT8) */
#define SEG_GPU_DVFS_VOLT6        76875   /* 10uV (Antigo VOLT9) */
#define SEG_GPU_DVFS_VOLT7        75625   /* 10uV (Antigo VOLT10) */
#define SEG_GPU_DVFS_VOLT8        75000   /* 10uV (Antigo VOLT11) */
#define SEG_GPU_DVFS_VOLT9        73750   /* 10uV (Antigo VOLT12) */
#define SEG_GPU_DVFS_VOLT10       72500   /* 10uV (Antigo VOLT13) */
#define SEG_GPU_DVFS_VOLT11       71250   /* 10uV (Antigo VOLT14) */
#define SEG_GPU_DVFS_VOLT12       70625   /* 10uV (Antigo VOLT15) */
#define SEG_GPU_DVFS_VOLT13       70000   /* 10uV (Antigo VOLT16) */
#define SEG_GPU_DVFS_VOLT14       69375   /* 10uV (Antigo VOLT17) */
#define SEG_GPU_DVFS_VOLT15       68750   /* 10uV (Antigo VOLT18) */
#define SEG_GPU_DVFS_VOLT16       68125   /* 10uV (Antigo VOLT19) */
#define SEG_GPU_DVFS_VOLT17       66875   /* 10uV (Antigo VOLT20) */
#define SEG_GPU_DVFS_VOLT18       66875   /* 10uV (Antigo VOLT21) */
#define SEG_GPU_DVFS_VOLT19       66250   /* 10uV (Antigo VOLT22) */
#define SEG_GPU_DVFS_VOLT20       65625   /* 10uV (Antigo VOLT23) */
#define SEG_GPU_DVFS_VOLT21       65000   /* 10uV (Antigo VOLT24) */
#define SEG_GPU_DVFS_VOLT22       64375   /* 10uV (Antigo VOLT25) */
#define SEG_GPU_DVFS_VOLT23       64375   /* 10uV (Antigo VOLT26) */
#define SEG_GPU_DVFS_VOLT24       63750   /* 10uV (Antigo VOLT27) */
#define SEG_GPU_DVFS_VOLT25       63125   /* 10uV (Antigo VOLT28) */
#define SEG_GPU_DVFS_VOLT26       62500   /* 10uV (Antigo VOLT29) */
#define SEG_GPU_DVFS_VOLT27       61875   /* 10uV (Antigo VOLT30) */
#define SEG_GPU_DVFS_VOLT28       61250   /* 10uV (Antigo VOLT31) */
#define SEG_GPU_DVFS_VOLT29       61250   /* 10uV (Repetido, não há valor <) */
#define SEG_GPU_DVFS_VOLT30       61250   /* 10uV (Repetido, não há valor <) */
#define SEG_GPU_DVFS_VOLT31       61250   /* 10uV (Repetido, não há valor <) */

/* Rampa de VSRAM Suavizada e com Undervolt */
#define SEG_GPU_DVFS_VSRAM0       97500   /* 10uV (Antigo VSRAM3) */
#define SEG_GPU_DVFS_VSRAM1       95000   /* 10uV (Antigo VSRAM4) */
#define SEG_GPU_DVFS_VSRAM2       92500   /* 10uV (Antigo VSRAM5) */
#define SEG_GPU_DVFS_VSRAM3       90000   /* 10uV (Antigo VSRAM6) */
#define SEG_GPU_DVFS_VSRAM4       89375   /* 10uV (Antigo VSRAM7) */
#define SEG_GPU_DVFS_VSRAM5       88125   /* 10uV (Antigo VSRAM8) */
#define SEG_GPU_DVFS_VSRAM6       86875   /* 10uV (Antigo VSRAM9) */
#define SEG_GPU_DVFS_VSRAM7       85625   /* 10uV (Antigo VSRAM10) */
#define SEG_GPU_DVFS_VSRAM8       85000   /* 10uV (Antigo VSRAM11) */
#define SEG_GPU_DVFS_VSRAM9       85000   /* 10uV (Valor mínimo) */
#define SEG_GPU_DVFS_VSRAM10      85000   /* 10uV (Valor mínimo) */
#define SEG_GPU_DVFS_VSRAM11      85000   /* 10uV (Valor mínimo) */
