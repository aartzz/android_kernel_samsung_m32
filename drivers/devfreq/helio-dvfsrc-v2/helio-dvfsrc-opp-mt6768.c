...
void dvfsrc_opp_level_mapping(void)
{
	...
	case SPMFW_LP4_2CH_3200:
		...
		set_ddr_opp(VCORE_DVFS_OPP_12, DDR_OPP_1);
		set_ddr_opp(VCORE_DVFS_OPP_13, DDR_OPP_1);
		set_ddr_opp(VCORE_DVFS_OPP_14, DDR_OPP_1);
		set_ddr_opp(VCORE_DVFS_OPP_15, DDR_OPP_1);
		break;
